...
from dataspace_sdk.model.contractdefinition import ContractDefinitionOutputDTO, \
    ContractDefinitionInputDTO, ContractState
...
class ContractDefinitionsClient:
    ...
    def change_state(self, contract_id: str, state: ContractState) -> None:
        ...
        self._client.put(
            ...
            json=state.model_dump(by_alias=True),
        )
